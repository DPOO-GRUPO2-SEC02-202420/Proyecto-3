...
public class AdministrarLearningPath extends JFrame {
    ...
    btnAgregarActividad.setAlignmentX(Component.CENTER_ALIGNMENT);
    ...
    btnGuardarActividades.setAlignmentX(Component.CENTER_ALIGNMENT);
    ...
    btnVolverMenu.setAlignmentX(Component.CENTER_ALIGNMENT);
    ...
    private void mostrarVentanaEliminarActividad() {
        ...
        for (Actividad act : learningPathSeleccionado.getActividades()) {
            ...
            modelo.addElement(act.getTitulo()); 
        }
